	...
	<view class="login_title">
		...
		<view class="login_center">
			...
			<view class="login_uesr">
				...
				<input class="login_psw_input" type="password" v-model="user_psw" @blur="user_psw_2" placeholder="请输入新密码" placeholder-style="color:white" />
			</view>
			<view class="login_uesr">
				<view class="login_psw_img" :style="'background: url(' + img_url + 'user_psw.png) rgba(255, 255, 255, 0.19) no-repeat center;background-size: 80%;'"></view>
			...
			<view class="login_uesr"><view class="login_uesr_btn" @click="lj_register">修改密码</view></view>
			<view class="login_uesr">
				<navigator url="register" class="login_uesr_p1">立即注册</navigator>
				<navigator url="login" class="login_uesr_p2">立即登录</navigator>
			</view>
		</view>
		<view>
